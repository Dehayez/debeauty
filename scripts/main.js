document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.navbar__links > li > a:not(.navbar__logo-link)').forEach(link => {
        ...
        swirl.style.width = '100%';
        swirl.style.height = '22px';
        swirl.style.pointerEvents = 'none';
        swirl.style.overflow = 'visible';
        swirl.style.display = 'block';
        swirl.style.zIndex = 1;
        ...
        link.addEventListener('mouseenter', () => {
            ...
            gsap.to(stroke, { strokeDashoffset: 0, duration: 0.7, ease: 'power2.out' });
        });
        link.addEventListener('mouseleave', () => {
            const fill = swirl.querySelector('.navbar__swirl-fill');
            fill.style.opacity = '0';
            gsap.to(stroke, { strokeDashoffset: pathLength, duration: 0.5, ease: 'power2.in' });
        });
    });
});